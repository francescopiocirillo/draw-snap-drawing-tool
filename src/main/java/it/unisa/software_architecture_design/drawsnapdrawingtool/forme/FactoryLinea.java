...
public class FactoryLinea implements FactoryForma{
    //non serve specificare il costruttore perchè non essendoci parametri è vuoto
    /**
    ...
    public Forma creaForma(double coordinataX, double coordinataY, double altezza, double larghezza, double angoloInclinazione, Color colore, Color coloreInterno) {
        return new Linea(coordinataX, coordinataY, larghezza, angoloInclinazione, colore);
    }
}
